...
process.env = {
  ...
  ACCESS_TOKEN_PRIVATE_KEY: path.resolve('certs/ecdsa.key'),
  ACCESS_TOKEN_PUBLIC_KEY: path.resolve('certs/ecdsa.key.pub'),
  PRIVATE_KEY_PATH: path.resolve('certs/ecdsa.key'),
  PUBLIC_KEY_PATH: path.resolve('certs/ecdsa.key.pub'),
